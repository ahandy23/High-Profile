...
func whereToLook (location: Location) -> String{
    ...
    case .mistressHome:
        return "Found at Kathy"
    case .movies:
        return "Found at BelAir"
    }
}
...
func morningSchedule() {
    ...
    print("\(Main) then walks in her massive walk in closet, and grabs her suit, and shoes,and dresses herself,she then calls for snickers, walks to his room and wakes him up.")
    ...
    print("\(Main) then calls out her snickers, grab's his bowl, and pour's his food into his bowl. After he is finishes his food, she cleans out his bowl set's it aside, and takes snickers back to his room.")
...
func chapterOne() {
    ...
    print("Ashley comes down, and speaks to \(Main)\"Hello Ms.Pierce, how are you, what would you like for me to grab\"")
    ...
    //storyUsingLoop()
    print("\"\(Main), calls back Harold back,\"Hey Harold, you said you have new info regarding the case\".")
    ...
    print("\"\(client7) hired a private investigator, late in the marriage, and he has proof of his cheating, documented.\"")
    ...
    print("\"Hey James, this is Ms.Pierce, I am \(client7) lawyer,I heard that you have some good news for us.\"")
    ...
    print("Jean-Georges is a restaurant that Amanda frequently visits, \"have I ever cross paths with this man?\", she thinks to herself.")
